	...
	<main class="main_wrapper_slots pb-0">
		...
		<div class="container z-index-3 main_gap">
						...
						<Breadcrumbs
							:value="[
								...
								},
								{
									...
									permalink: `/${progamblersBlueprintRootSlug}`
								},
								{
			...
			<div id="top_casinos" :style="{ order: data.body.order_components['top_casinos'] }">
				<TopCasinoList v-if="data.body.casinos.length" :posts="data.body.casinos" schema />
			</div>
			<ContentWrapper
...
import { PROGAMBLERS_BLUEPRINT_ROOT_SLUG } from '~/constants'
...
export default {
	...
	data: () => {
		return {
			progamblersBlueprintRootSlug: PROGAMBLERS_BLUEPRINT_ROOT_SLUG,
