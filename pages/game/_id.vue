	...
	<div>
		<main class="game_page">
			...
			<div
				...
				id="breadcrumbs"
				:style="{ order: data.body.order_components['breadcrumbs'] }"
			>
			...
			<div
				class="container z-index-3"
				id="top_card"
				:style="{ order: data.body.order_components['top_card'] }"
			>
				<SlotCard
					:title="data.body.title"
			...
			<section id="characters" class="bg_grey p-gap" :style="{ order: data.body.order_components['characters'] }">
				<div class="container main_gap">
					...
					<div class="stats">
						...
						<div class="stats_item">
							<GameStatsItem
								src="/img/multiplier.svg"
								title="Multiplier"
								:isCheck="Boolean(data.body.characters_multiplier)"
							/>
						</div>
						<div class="stats_item">
			...
			>
				<h2 class="text_color_cairo m-0">{{ t('MOBILE_VERSION') }}</h2>
				<MobileVersion
			...
			<div
				...
				:style="{ order: data.body.order_components['bonuses'] }"
			>
				<h2 class="text_color_cairo m-0" v-if="data.body.bonuses_title">{{ data.body.bonuses_title }}</h2>
			...
			>
				<h2 class="text_color_cairo m-0" v-if="data.body.games_title">{{ data.body.games_title }}</h2>
			...
			<div
				class="review_container z-index-3"
				id="reviews"
